...
There are many factors ranging from location, material quality, property size, and age, that influence the real estate market. The Ames data set provides a comprehensive selection of these property features that we can use to study there relationship and impact on home sales price. We aim to analyse the relationship of variables in the data set with the sale price as the response. We will explore which variables influence the most towards the sales price and we will further analyse how well each variable follow the LINE assumptions and how we can fix in case of an assumption is violated. Our results can be used to assist home sellers, policymakers, and real estate professionals better identify important factors in home prices.
