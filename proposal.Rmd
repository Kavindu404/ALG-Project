...
There are many factors ranging from location, material quality, property size, and age, that influence the real estate market. The Ames data set provides a comprehensive selection of these property features that we can use to study there relationship and impact on home sales price. We wish to build a model to make predictions about prices and provide insights about the key factors that influence them. Our results can be used to assist home sellers, policymakers, and real estate professionals better identify important factors in home prices.
